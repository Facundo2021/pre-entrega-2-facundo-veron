...
const ItemDetail = ({ id, nombre, precio, img, stock }) => {
  ...
  return (
    <div className='contenedorItem'>
      ...
      <h3>Precio: {precio} </h3>
      <h3>ID: {id} </h3>
      <p> Bicicleta confiable y duradera garantizada por la marca por 12 meses, con fabricacion nacional. Estan en varios tonalidades de colores disponibles tanto hombres como mujeres.</p>
